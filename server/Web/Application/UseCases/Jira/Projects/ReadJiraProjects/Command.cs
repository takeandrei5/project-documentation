...
namespace ProjectDocumentation.Web.Application.UseCases.Jira.Projects.ReadJiraProjects;
...
public sealed class Command
{
    ...
    public async Task<Result<JiraProjectsDto, BaseError>> ExecuteAsync(CancellationToken cancellationToken)
    {
        var uri = new Uri("/api/jira/projects");
