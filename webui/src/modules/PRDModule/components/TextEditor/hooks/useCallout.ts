...
const useCallout = () => {
	const initializeCallout = (editor: TinyMCEEditor): void => {
		editor.ui.registry.addIcon('callout', calloutSvg);
		editor.ui.registry.addIcon(
			'callout-swatch-blue',
			'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"><rect width="18" height="18" x="3" y="3" fill="#76B8E4" fill-rule="evenodd" rx="2"/></svg>'
		);
		editor.ui.registry.addIcon(
			'callout-swatch-yellow',
			'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"><rect width="18" height="18" x="3" y="3" fill="#FAD281" fill-rule="evenodd" rx="2"/></svg>'
		);
		editor.ui.registry.addIcon(
			'callout-swatch-red',
			'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"><rect width="18" height="18" x="3" y="3" fill="#FF8686" fill-rule="evenodd" rx="2"/></svg>'
		);
		editor.ui.registry.addIcon(
			'callout-swatch-orange',
			'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"><rect width="18" height="18" x="3" y="3" fill="#FFC286" fill-rule="evenodd" rx="2"/></svg>'
		);
